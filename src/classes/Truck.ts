...
class Truck extends Vehicle implements AbleToTow {
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    if (vehicle.make && vehicle.model) {
      ...
      console.log('The vehicle has no make or model');
    }
  }
  ...
  override printDetails(): void {
    ...
    console.log(
      `Wheel 1: ${this.wheels[2].getDiameter} inch with a ${this.wheels[2].getTireBrand} tire`
    );
    console.log(
      `Wheel 1: ${this.wheels[3].getDiameter} inch with a ${this.wheels[3].getTireBrand} tire`
    );
  }
